...
$.fn.smapPopup = function (opts) {
  ...
  var p = $(
    '<div class="popup"><div class="popup-overlay"></div><div class="popup-inner"></div></div>'
  );
  ...
  if (opts.onBeforeOpen) opts.onBeforeOpen.call(t, p);

  p.fadeIn(function () {
    if (opts.onComplete) opts.onComplete.call(t, p);
  });

  if (opts.onOpen) opts.onOpen.call(t, p);
