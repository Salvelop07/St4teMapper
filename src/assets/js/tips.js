    ...
    tips.push(
      tippy(".tipping-" + i, {
        ...
        onShow: function () {
          ...
          if (inner.is(".loaded, .loading")) return;

          var loading =
            c && (c.loading || c.loading === false) ? c.loading : SMAP.loading;
          if (loading) inner.addClass("loading").html(loading);
